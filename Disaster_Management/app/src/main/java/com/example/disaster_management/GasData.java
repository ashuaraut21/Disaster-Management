...
public class GasData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(GasData.this,""+e,Toast.LENGTH_LONG).show();
        }
    ...
    private void getJSON(final String urlWebService) {
        ...
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                progress = ProgressDialog.show(GasData.this, null, "Login...");
                super.onPreExecute();
            }
            @Override
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        if(json.contentEquals("FAIL")){
            Toast.makeText(GasData.this,"Please Enter Valid Username & Password",Toast.LENGTH_LONG).show();
        }else{
            Toast.makeText(GasData.this,json,Toast.LENGTH_LONG).show();
