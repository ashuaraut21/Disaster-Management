...
public class FireData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            url=url+"firedata.php";
            getJSON(url);
        }catch (Exception e){
            Toast.makeText(FireData.this,""+e,Toast.LENGTH_LONG).show();
        }
    ...
    private void getJSON(final String urlWebService) {
        ...
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                progress = ProgressDialog.show(FireData.this, null, "Login...");
                super.onPreExecute();
            }
            @Override
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        if(json.contentEquals("FAIL")){
            Toast.makeText(FireData.this,"Please Enter Valid Username & Password",Toast.LENGTH_LONG).show();
        }else{
            Toast.makeText(FireData.this,json,Toast.LENGTH_LONG).show();
